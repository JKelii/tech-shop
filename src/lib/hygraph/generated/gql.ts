 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateOrderId($stripeCheckoutId: String!, $total: Int!, $email: String!) {\n  createOrder(\n    data: {stripeCheckoutId: $stripeCheckoutId, total: $total, account: {connect: {email: $email}}}\n  ) {\n    id\n    stripeCheckoutId\n    orderItems {\n      quantity\n      product {\n        slug\n        name\n        price\n        images(first: 1) {\n          url\n        }\n      }\n    }\n  }\n}"): typeof import('./graphql').CreateOrderIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
