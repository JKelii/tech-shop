    ...
    <main className="flex justify-center items-center w-full  ">
      <Link href={`/item/${products[index].slug}`} key={products[index].id}>
        <span className="w-full h-full">
          <article className="border-2 border-gray-500 shadow-md hover:border-gray-700 w-80 h-80 rounded-md flex justify-center items-center flex-col flex-wrap hover:translate-y-[-2px] transition ">
            <Image
