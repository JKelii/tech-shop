...
const Home = async () => {
  ...
  return (
    <main className="container mx-auto w-full flex justify-center items-center flex-col  shadow-md gap-12 mt-4 mb-8 bg-gray-100/50 border-2 border-gray-200 p-10 rounded-lg">
